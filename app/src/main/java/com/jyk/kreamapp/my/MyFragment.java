...
public class MyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = (View) inflater.inflate(R.layout.fragment_my, container, false);

        viewPager2 = view.findViewById(R.id.vp_my_shopping);
        tabLayout = view.findViewById(R.id.tab_layout_my);
